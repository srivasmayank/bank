    ...
    <div className="w-full h-full">
      ...
      <div className="relative z-10 flex flex-col min-h-full border-b-6 border-green-700">
        ...
        <div className="flex relative flex-grow pt-10 justify-center px-6 pb-35">
          <div
            className="hidden md:block absolute inset-0 bg-cover bg-center h-full"
          ...
          <div className="flex md:flex-row flex-col gap-10 justify-evenly w-full relative z-10">
            ...
            <div className="w-full md:w-auto">
              ...
              <div className="bg-white p-6 px-8 md:shadow-lg md:opacity-65">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    className="w-full bg-gray-100 text-gray-400 py-2 mb-4 font-[600] rounded cursor-pointer border-2"
                    type="submit"
                  >
                    Log in
                  </button>
            ...
            {/* Right Side Text */}
            <div className="space-y-2 mt-10 md:mt-20 md:ml-30">
              <div className="space-y-4 border-b border-gray-400 pb-6 w-full">
              ...
              <div>
                <p className="text-green-500 font-[500] flex gap-2 items-center">
                  <MdLockOutline className="mt-1 text-lg text-black" />
                  Find out more about TD Bank's online security
                </p>
      ...
      {/* Footer */}
      <footer className="bg-gray-100 text-sm text-gray-700 md:h-screen h-full">
        ...
        <div className="px-8 py-4 text-xs max-w-4xl mx-auto">
          ...
          <div className="text-xs py-2 pt-4">
